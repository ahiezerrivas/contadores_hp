"""
Logica compartida para importar los reportes mensuales de contadores (Excel)
hacia MonthlyCounterEntry. No es un comando en si mismo (el guion bajo al
inicio del nombre de archivo evita que Django lo registre como tal); los
comandos reales (import_counters, import_counters_torre,
import_counters_oficina) heredan de BaseImportCountersCommand.
"""
...
HEADER_TO_FIELD = {
    ...
    "nombre de host sede": "display_name",
    "nombre de host oficina": "display_name",
    "displayname": "printer_model",
    "display name": "printer_model",
